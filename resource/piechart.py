...
class Window(QMainWindow):
    ...
    def pie_chart(self):
        ...
        try:
            ...
            cursor = mydb.cursor()
            query = "select count(emp_id) from property join seller where mode = 'Rented' and emp_id = 5 and seller.seller_id=property.seller_id"
            query2 = "select count(emp_id) from property join seller where mode = 'Sold' and emp_id = 5 and seller.seller_id=property.seller_id"
            query3 = "select count(emp_id) from seller where emp_id=5"
